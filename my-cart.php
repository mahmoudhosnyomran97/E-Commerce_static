...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "EG"." ".$row['productPrice']; ?>.00</span></td>

					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo "EG"." ".($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']); ?>.00</span></td>
				</tr>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						GrandTotal<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00EG"; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
